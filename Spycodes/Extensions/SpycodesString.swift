class SpycodesString {
    ...
    static let leaderGuess = "Now it's time for your teammates to guess. Your teammates can tap End Round at any time. If they guess the Assassin word, then it's game over. Guessing neutral and enemy team's words will automatically end the round."
    ...
    static let playerGuess = "Now it's your turn to guess! You can tap End Round at any time. If your team guesses the Assassin word, then it's game over. Guessing neutral and enemy team's words will automatically end the round."
