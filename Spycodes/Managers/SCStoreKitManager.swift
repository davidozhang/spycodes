...
// Modified based on https://github.com/atjason/IAPHelper/blob/master/IAPDemo/IAPDemo/IAP/IAPHelper.swift
public class SCStoreKitManager: NSObject {
    static let instance = SCStoreKitManager()
...
extension SCStoreKitManager: SKProductsRequestDelegate {
...
extension SCStoreKitManager: SKPaymentTransactionObserver {
