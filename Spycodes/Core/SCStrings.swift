...
class SCStrings {
    ...
    enum pregameOnboarding: String {
        case chevrons = "Chevrons in the app can be tapped on. They also indicate swipe support in the direction it is pointing."
        ...
        case helpAccess = "You can always access this help view by tapping on the help button."
        ...
        case pregameMenu = "Swipe up in the pregame view to access game and category settings."
